...
public class GUIManual extends JFrame {
    ...
    public void buscarSelecciones(String dato) {
        selecciones = seleccionDAO.getSeleccionesMatriz(dato);
        pintarTablaSelecciones();
    }

    public boolean validarTextField(JTextField jtextfield) {
        boolean campo = false;

        if (jtextfield.getText().isEmpty()) {
            campo = true;
            JOptionPane.showMessageDialog(null, "Campo 'Busqueda de Equipos' vacio.");
        }
